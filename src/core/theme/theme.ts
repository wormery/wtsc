...
export class Theme<Options extends ThemeOptions<Options>> extends Inject {
  ...
  constructor(options: Options) {
    ...
    //在亮色中选中第一个主题
    ;(this.themeList as any).bright[choice] = this.theFirstOne(
      (this.themeList as any).bright
    )
    //在暗色中选中第一个主题
    ;(this.themeList as any).dark[choice] = this.theFirstOne(
      (this.themeList as any).dark
    )
  }
  private theFirstOne(o: object) {
